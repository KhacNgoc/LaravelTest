            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="card rounded-3">
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('edit_complete_task', $task['id']) }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control" name="title" required value="{{ $task['title'] }}" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="content" type="text" class="form-control" name="content" value="{{ $task['content'] }}" required>
                                </div>
                            </div>
